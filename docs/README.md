...
| 16 | [Language](./16-localisation.md) | The translation layer behind the English/বাংলা select, why switching is a redraw rather than a reload, and what is translated so far. |
