 ...
 * validates. It is not a secret. The Android client ID Google Cloud also has
 * registered (against `com.ningshingche.app` and the debug SHA-1) is not needed
 * here: Credential Manager never sends it.
 *
