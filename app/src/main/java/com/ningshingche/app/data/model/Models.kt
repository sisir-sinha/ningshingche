...
/**
 * Interface language. Bengali is the language the strings are written in;
 * Bishnupriya Manipuri is served from the table generated by
 * `i18n/generate_strings.py`, and falls back to the Bengali original for any
