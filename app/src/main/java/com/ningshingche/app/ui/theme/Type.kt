...
val EditorialTypography = Typography(
    ...
    displaySmall = bengaliTextStyle(FontWeight.SemiBold, textSize(26), leading(26)),
    headlineLarge = bengaliTextStyle(FontWeight.Bold, textSize(24), leading(24)),
    headlineMedium = bengaliTextStyle(FontWeight.SemiBold, textSize(22), leading(22)),
    headlineSmall = bengaliTextStyle(FontWeight.Medium, textSize(20), leading(20)),
    titleLarge = bengaliTextStyle(FontWeight.Bold, textSize(20), leading(20)),
    ...
    bodyLarge = bengaliTextStyle(FontWeight.Normal, textSize(18), leading(18)),
    bodyMedium = bengaliTextStyle(FontWeight.Normal, textSize(16), leading(16)),
