import{c as s}from"./router-DkUXv8lC.js";function t(){return`
  <div class="min-h-screen bg-slate-50">
    ...
    <div class="max-w-[1120px] mx-auto px-4 py-6">
      ...
      <div class="mt-6 lg:hidden bg-white border border-slate-200 rounded-[20px] p-3 flex justify-around">
        ${["home","point_of_sale","book","inventory_2","bar_chart"].map((a,e)=>`
          <div class="flex flex-col items-center gap-1 ${e===0?"text-slate-900":"text-slate-400"}">
            <span class="material-symbols-rounded ${e===0?"bg-slate-900 text-white p-1.5 rounded-full":""}">${a}</span>
            <span class="text-[10px] font-bold">${["Home","POS","Khata","Stock","Hisab"][e]}</span>
          </div>
        `).join("")}
      </div>
    </div>
  ...
  `}const r=document.getElementById("app");s([{path:"/app",view:t,title:"Mekholi App — Home"},{path:"/app.html",view:t,title:"Mekholi App — Home"},{path:"/app/pos",view:l,title:"Mekholi App — POS"},{path:"/app/khata",view:d,title:"Mekholi App — Khata"},{path:"/",view:()=>(location.href="/","")}],r);
